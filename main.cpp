...
static void drawSmallText2D(float sx, float sy, const char* text,
...
static void drawStartMenu()
{
    ...
    glBegin(GL_QUADS);
        glColor3f(0.172f, 0.224f, 0.188f);
        glVertex2f(0, 0);

        glColor3f(0.118f, 0.153f, 0.130f);
        glVertex2f(w, 0);

        glColor3f(0.247f, 0.310f, 0.267f);
        glVertex2f(w, h);
    ...
    drawSmallText2D(
        w / 2.0f - 160.0f,
        h / 2.0f + 70.0f,
        "Pecahkan 7 teka-teki sebelum waktu habis.",
        0.863f,
        0.843f,
        0.788f
    );
    ...
    drawConditionBox(
        ...
        56.0f,
        "KAMERA",
        "Mouse / Arrow Keys untuk melihat bebas"
    );
    ...
    drawConditionBox(
        ...
        56.0f,
        "POV / RESET",
        "Tekan V ganti POV, tekan R restart"
    );
    ...
    drawText2D(
        w / 2.0f - 150.0f,
        h / 2.0f - 165.0f,
        "Klik tombol atau tekan ENTER / SPACE",
        0.863f,
        0.843f,
        0.788f
    );
...
void display()
{
    ...
    sprintf(
        title,
        "Master Crack: The 7th Golden Silence | WAKTU: %02d:%02d | NYAWA: %d | SELESAI: %d/7 | P-AKTIF: %d | POV: %s",
        timeLeft / 60,
        timeLeft % 60,
        livesLeft,
        solvedCount,
